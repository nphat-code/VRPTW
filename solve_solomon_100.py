...
def plot_solution(data_rows, routes, save_path=None):
    ...
    plt.title('Minh họa Lộ trình (100 Customers)')
...
def solve_vrptw_100(file_path):
    ...
    start_line = 9
    n_customers = 100 
    lines_to_read = n_customers + 1 # 100 khách + 1 depot
    ...
    search_parameters.time_limit.seconds = 60 # Giây là đủ cho OR-Tools tìm ra lời giải tốt
    ...
    if solution:
        ...
        with open('solution_100.txt', 'w', encoding='utf-8') as f_out:
        ...
        plot_solution(data_rows, all_routes, 'route_images/solution_100.png')
    else:
